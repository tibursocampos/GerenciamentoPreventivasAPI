...
namespace APIPreventivas.Migrations
{
    public partial class populadb2 : Migration
    {
        protected override void Up(MigrationBuilder mb)
        {
            ...
            //mb.Sql("INSERT INTO cronogramas VALUES(1,4,2020,0)");
            ...
            //mb.Sql("INSERT INTO alvos(id_cronograma, id_supervisor, Site_end_id, Id_tecnico_prog_aterramento) VALUES(2,2,'MGPSA_0001',5)");
            //mb.Sql("INSERT INTO alvos(id_cronograma, id_supervisor, Site_end_id, Id_tecnico_prog_aterramento) VALUES(2,2,'MGPSA_0002',5)");
            //mb.Sql("INSERT INTO alvos(id_cronograma, id_supervisor, Site_end_id, Id_tecnico_prog_aterramento) VALUES(2,2,'MGPCS_0001',6)");
            //mb.Sql("INSERT INTO alvos(id_cronograma, id_supervisor, Site_end_id, Id_tecnico_prog_aterramento) VALUES(2,2,'MGPCS_0002',6)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(1,1)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(2,2)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(1,3)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(2,4)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(23,33)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(23,34)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(24,35)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(24,36)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(25,37)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(25,39)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(26,39)");
            //mb.Sql("INSERT INTO tecnicosalvos VALUES(26,40)");
        }
