...
namespace APIPreventivas.Migrations
{
    ...
    [Migration("20200612203137_inicio-banco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Preventivas.Models.Alvo", b =>
                {
            ...
            modelBuilder.Entity("Preventivas.Models.Cronograma", b =>
                {
                    b.Property<int>("Id_cronograma")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Preventivas.Models.Site", b =>
                {
            ...
            modelBuilder.Entity("Preventivas.Models.Supervisor", b =>
                {
            ...
            modelBuilder.Entity("Preventivas.Models.Tecnico", b =>
                {
                    b.Property<int>("Id_funcionario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Preventivas.Models.TecnicoAlvo", b =>
                {
                    b.Property<int>("Id_alvo")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Preventivas.Models.Alvo", b =>
                {
                    b.HasOne("Preventivas.Models.Cronograma", "Cronogramas")
                        .WithMany("Alvos")
                        .HasForeignKey("Id_cronograma")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Preventivas.Models.Site", "Sites")
                        .WithMany("Alvos")
            ...
            modelBuilder.Entity("Preventivas.Models.Cronograma", b =>
                {
                    b.HasOne("Preventivas.Models.Supervisor", "Supervisores")
            ...
            modelBuilder.Entity("Preventivas.Models.TecnicoAlvo", b =>
                {
                    b.HasOne("Preventivas.Models.Alvo", "Alvo")
                        .WithMany("Tecnicos_alvos")
                        .HasForeignKey("Id_alvo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Preventivas.Models.Tecnico", "Tecnico")
                        .WithMany("Tecnicos_alvos")
